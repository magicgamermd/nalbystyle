...
ТЕЛЕФОН — КРИТИЧНО:
- Когато попиташ за телефон, СПРИ и ИЗЧАКАЙ поне 5 секунди!
- Клиентът казва бавно цифра по цифра — НЕ го прекъсвай!
- Събери ВСИЧКИ цифри. При 10 цифри → повтори цифра по цифра.
- Само ако каже "не" → питай отново.
